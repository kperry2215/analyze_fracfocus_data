...
def main():
    ...
    fracfocus_registry=pd.read_csv('fracfocus_registry_master.csv', low_memory=False)
    ...
    basic_frac_characteristics=subsetted_df[['JobStartDate', 'JobEndDate', 'APINumber', 
                                             ...
                                             'TotalBaseWaterVolume', 'Latitude', 'Longitude']].drop_duplicates()
    #Plot the 'TotalBaseWaterVolume' variable over time
    generate_scatter_plot(basic_frac_characteristics, x_variable='JobStartDate', 
              y_variables=['TotalBaseWaterVolume'], plot_title='Total Base Water Volume for Fracs over Time')
    #Plot the 'TotalBaseNonWaterVolume' variable over time
    generate_scatter_plot(basic_frac_characteristics, x_variable='JobStartDate', 
              y_variables=['TotalBaseNonWaterVolume'], plot_title='Total Base Non-Water Volume for Fracs over Time')
    ...
    vendor_data_stacked_bar_graph_pivoted=vendor_data_stacked_bar_graph.pivot(index='JobStartDateQuarter', 
                                                            columns='Supplier', 
    ...
    generate_bar_graph(vendor_data_stacked_bar_graph_pivoted, title='Number of Times Vendor Was Purchased From Over Quarter')
